...
def main():
    ...
    extra_features_dict=extra_features_dict, graph=g, noise_std=.15, save_folder="data/pickle/ds_creation_d/my_dict_comb.pickle") # , ds_creation_dict=my_ds_creation_dict,
